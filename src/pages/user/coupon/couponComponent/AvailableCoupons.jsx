        ...
        dataCoupon.map((coupon, index) => (
          <div key={index}>
            <div className='relative w-[312px]'>
              <img src={coupon.discountType === 'percentage' ? CouponPercent : CouponPrice} alt='icon' />
              <div
                className={`${
              ...
              >
                <div className='flex flex-col items-center text-[#3B3B3B]'>
                  <div
                    className={`${
                      coupon.discountType === 'percentage' ? 'text-[#B5955E]' : 'text-[#3B3B3B]'
                  ...
                  <div
                    className={`${
                      coupon.discountType === 'percentage' ? 'text-[#3B3B3B]' : 'text-[#D1B584]'
                  ...
                  <div className='text-[10px] font-medium'>최소 주문 금액: {coupon.minOrderValue} 원</div>
